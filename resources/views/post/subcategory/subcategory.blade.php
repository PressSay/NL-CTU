<x-app-layout :categoryPost="1" :title="'child Category Post'" >
  <!-- nav-links-forum -->
  <div class="block my-7  md:my-4">
    <div class="text-sm breadcrumbs hidden sm:block">
      <ul>
        ...
        <li><a href="/post/category-for-subcategory/{{ str_replace(' ','_',$category->title).'-'.$category->id }}">{{ $category->title }}</a></li>
        <li>new subcategory</li>
      </ul>
    </div>
