<x-app-layout :title="$category->title" :threads="1">
  @auth
  ...
  <div class="flex">
    ...
    <div class="flex flex-col justify-center items-center basis-1/2">
      <a href="/post/{{ str_replace(' ','_',$category->title).'-'.$category->id }}/create-thread" class="btn btn-xs">
