...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    ...
    <body class="font-sans text-gray-900 antialiased">
        <div class="container mx-auto flex flex-col sm:justify-center items-center pt-3 bg-base-100">
            <div>
                <a href="/">
...
<?php endif; ?>
            ...
            <div class="w-4/5 bg-base-100 shadow-md overflow-hidden sm:rounded-lg">
                <?php echo e($slot); ?>
...
<?php /**PATH /home/lpq/DoAn/NenLuanCoSo/laravel/Forum/resources/views/layouts/guest.blade.php ENDPATH**/ ?>