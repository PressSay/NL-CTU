...
<?php endif; ?>
    ...
    <form method="POST" action="<?php echo e(route('login')); ?>" class="p-2">
        <?php echo csrf_field(); ?>
...
<?php endif; ?>
        ...
        <div class="flex items-center justify-end mt-4">
            ...
            <?php if(Route::has('register')): ?>
                <a class="underline text-sm text-gray-600 hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 mr-2" href="<?php echo e(route('register')); ?>">
...
<?php endif; ?>
<?php /**PATH /home/lpq/DoAn/NenLuanCoSo/laravel/Forum/resources/views/auth/login.blade.php ENDPATH**/ ?>